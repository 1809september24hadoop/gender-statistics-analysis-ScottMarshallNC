...
import com.revature.reduce.PercentFemaleEmployementByCountryReducer;

public class PercentFemaleEmployement {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setReducerClass(PercentFemaleEmployementByCountryReducer.class);
