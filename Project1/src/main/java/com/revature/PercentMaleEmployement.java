...
import com.revature.reduce.PercentMaleEmployementByCountryReducer;

public class PercentMaleEmployement {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setReducerClass(PercentMaleEmployementByCountryReducer.class);
