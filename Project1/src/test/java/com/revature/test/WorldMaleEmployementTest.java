...
public class WorldMaleEmployementTest {
	...
	public void setUp(){
		...
		WorldMaleEmploymentMapper mapper = new WorldMaleEmploymentMapper();
		mapDriver = new MapDriver<>();
		mapDriver.setMapper(mapper);
		
		WorldMaleEmploymentReducer reducer = new WorldMaleEmploymentReducer();
	...
	public void testMapper(){
		mapDriver.withInput(new LongWritable(1), new Text("\"World\",\"WLD\",\"Employment to population ratio"
				...
				+ ",\"72.0073062034121\""));
		mapDriver.withOutput(new Text("World;WLD;Employment to population ratio, 15+, male (%) "
	...
	public void testReducer(){
		...
		reduceDriver.withInput(new Text("World;WLD;Employment to population ratio, 15+, male (%) "
				+ "(modeled ILO estimate);SL.EMP.TOTL.SP.MA.ZS;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
				+ "75.8417788946383;75.7451372747231;75.428706359347;75.1743877888956;75.063150694736;"
				+ "74.8100333327059;74.5560073268663;74.1962421996127;74.0954708277255;73.9489970024712;"
				+ "73.7461080032518;73.2774040912997;73.0718231150595;73.0531516823621;73.0941332970239;"
				+ "73.0576439054338;73.1193907760343;72.8379994624721;72.1339009843366;72.0846370027268;"
				+ "72.0140632798919;71.9899178190254;71.9234108185349;71.948524392694;72.0275542304481;"
				+ "72.0073062034121"), values);
		reduceDriver.withOutput(new Text("World Employment to population ratio, 15+, male (%) "
				+ "(modeled ILO estimate) 2000 to 2015"), new DoubleWritable(-1.9214427720230987));
	...
	public void testMapReduce() {
		mapReduceDriver.withInput(new LongWritable(1), new Text("\"World\",\"WLD\",\"Employment to population ratio"
				...
				+ ",\"71.9899178190254\",\"71.9234108185349\",\"71.948524392694\",\"72.0275542304481\""
				+ ",\"72.0073062034121\""));
		mapReduceDriver.withOutput(new Text("World Employment to population ratio, 15+, male (%) "
				+ "(modeled ILO estimate) 2000 to 2015"), new DoubleWritable(-1.9214427720230987));
