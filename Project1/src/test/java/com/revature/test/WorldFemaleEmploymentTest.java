...
public class WorldFemaleEmploymentTest {
	...
	public void setUp(){
		...
		WorldFemaleEmploymentMapper mapper = new WorldFemaleEmploymentMapper();
		mapDriver = new MapDriver<>();
		mapDriver.setMapper(mapper);
		
		WorldFemaleEmploymentReducer reducer = new WorldFemaleEmploymentReducer();
	...
	public void testMapper(){
		mapDriver.withInput(new LongWritable(1), new Text("\"World\",\"WLD\",\"Employment to population ratio,"
				+ " 15+, female (%) (modeled ILO estimate)\",\"SL.EMP.TOTL.SP.FE.ZS\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"49.0048849081483\""
				...
				+ ",\"46.4441184118518\""));
		mapDriver.withOutput(new Text("World;WLD;Employment to population ratio, 15+, female (%) "
	...
	public void testReducer(){
		...
		reduceDriver.withInput(new Text("World;WLD;Employment to population ratio, 15+, female (%) "
				+ "(modeled ILO estimate);SL.EMP.TOTL.SP.FE.ZS;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
				+ "49.0048849081483;49.0952517511666;48.8900926643439;48.8690980408558;48.8425454291542;"
				+ "48.6738302692562;48.5544856145047;48.3131846507726;48.4457130472085;48.4789427159539;"
				+ "48.3973027356075;48.2836643902032;48.2306167028635;48.2850141870354;48.3610634498502;"
				+ "48.1723156782368;48.0797587714126;47.6831054329207;47.1142524546921;46.6975960863054;"
				+ "46.5284920555935;46.4530691098045;46.4442392613018;46.5597634947386;46.5444447857213;"
				+ "46.4441184118518;"), values);
		reduceDriver.withOutput(new Text("World Employment to population ratio, 15+, female (%) (modeled ILO estimate) 2000 to 2015"), new DoubleWritable(-1.9344979302325953));
		reduceDriver.runTest();
	}
	
	@Test
	public void testMapReduce() {
		mapReduceDriver.withInput(new LongWritable(1), new Text("\"World\",\"WLD\",\"Employment to population ratio,"
				+ " 15+, female (%) (modeled ILO estimate)\",\"SL.EMP.TOTL.SP.FE.ZS\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"49.0048849081483\""
				+ ",\"49.0952517511666\",\"48.8900926643439\",\"48.8690980408558\",\"48.8425454291542\""
				...
				+ ",\"46.4530691098045\",\"46.4442392613018\",\"46.5597634947386\",\"46.5444447857213\""
				+ ",\"46.4441184118518\""));
		mapReduceDriver.withOutput(new Text("World Employment to population ratio, 15+, female (%) (modeled ILO estimate) 2000 to 2015"), new DoubleWritable(-1.9344979302325953));
